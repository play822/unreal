...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AABGameMode_Statics::NewProp_ScoreToClear = { "ScoreToClear", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AABGameMode, ScoreToClear), METADATA_PARAMS(Z_Construct_UClass_AABGameMode_Statics::NewProp_ScoreToClear_MetaData, ARRAY_COUNT(Z_Construct_UClass_AABGameMode_Statics::NewProp_ScoreToClear_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AABGameMode_Statics::NewProp_ABGameState_MetaData[] = {
		{ "ModuleRelativePath", "Public/ABGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AABGameMode_Statics::NewProp_ABGameState = { "ABGameState", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AABGameMode, ABGameState), Z_Construct_UClass_AABGameState_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AABGameMode_Statics::NewProp_ABGameState_MetaData, ARRAY_COUNT(Z_Construct_UClass_AABGameMode_Statics::NewProp_ABGameState_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AABGameMode_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AABGameMode_Statics::PropPointers),
		0,
		0x009002A8u,
	...
	IMPLEMENT_CLASS(AABGameMode, 803625325);
